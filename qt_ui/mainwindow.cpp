...
MainWindow::MainWindow(QWidget* parent) : QWidget(parent) {
    ...
    connect(newChatButton_, &QPushButton::clicked, this, &MainWindow::newChat);
    ...
    historyList_->setStyleSheet(
        ...
        "}");
    connect(historyList_, &QListWidget::itemClicked, this, &MainWindow::loadChatHistory);
...
void MainWindow::addDateGroup(const QDate& date) {
...
void MainWindow::insertNewChatItem(const QDate& date, int count) {
    // 查找对应日期分组位置
    int datePos = -1;
...
void MainWindow::loadChatHistory(QListWidgetItem* item) {
